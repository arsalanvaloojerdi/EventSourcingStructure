...
namespace Framework.DomainModel.Equality
{
    /// <summary>
    ...
    public class EqualsBuilder
    {
            ...
            bool useTransients)
        {
            ...
            for (int i = 0; i < fields.Length && builder._isEqual; i++)
            {
    ...
    */
        ...
        public EqualsBuilder Append(Object[] lhs, Object[] rhs)
        {
            ...
            for (int i = 0; i < lhs.Length && _isEqual; ++i)
            {
                if (lhs[i] != null)
                {
                    ...
                    {
                        _isEqual = false; //If the types don't match, not equal
                        break;
                    }
                }
                Append(lhs[i], rhs[i]);
